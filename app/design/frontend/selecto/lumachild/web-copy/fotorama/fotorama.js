        ...
        function setStagePosition() {
            if ($stage !== undefined) {
                ...
                if (opts.navdir == 'vertical') {
                    ...
                    $stage.css('width', $wrap.width() - padding);
                    $stage.css('height', $wrap.height() - padding);
                    $arrNext.css('right', padding);
                    $fullscreenIcon.css('right', padding);
                    $wrap.css('width', $wrap.css('width') + padding);
                    $stageShaft.css('max-width', $wrap.width() - padding);
                    // $wrap.css('width', $wrap.css('width') - opts.thumbwidth);
                    // $stageShaft.css('max-width', $wrap.width() - padding);
                    // console.log($stage.width());
                    // console.log('test' + ($wrap.width() - padding));
                    ...
                    if (o_nav) {
                        switch (opts.navdir) {
                            ...
                            var padding = opts.thumbwidth + opts.thumbmargin;
                                ...
                                $nav
                                    .stop()
                                    .animate({height: measures.h - padding, width: opts.thumbwidth}, time);
                                break;
                            case 'list':
